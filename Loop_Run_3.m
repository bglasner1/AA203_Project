...
fprintf('Starting Run 3\r\n');
N_agents = 10; % Range of number of agents to simulate
CommRange = [4.1, 4.4, 4.7, 5.0, 5.3, 5.6, 5.9]; % Communication range - 0 is no comunication, 20 is full
ExecHorz = 2; % Number of steps to take before replanning.
