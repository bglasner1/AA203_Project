...
fprintf('Starting Run 5\r\n');
N_agents = [5,7];%10,11:3;20,25,30]; % Range of number of agents to simulate
CommRange = [0,1]; % Communication range - 0 is no comunication, 20 is full
